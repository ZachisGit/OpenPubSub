...
echo docker run -d --name ipfs-base --restart always -v $(realpath ipfs/staging):/export -v $(realpath ipfs/data):/data/ipfs -p 4001:4001 -p 4001:400grate=true --agent-version-suffix=docker --enable-pubsub-experiment > start.sh
